            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">{{ trans('menus.backend.resource.view-all') }}</h3>
                        ...
                        <div class="table-responsive">
                            <table id="resources-table" class="table table-condensed table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>{{ trans('labels.resources.full_name') }}</th>
    ...
    <script>
        $(function() {
            $('#resources-table').DataTable({
                ...
                //This section groups the data by the Building_location Name, which is in column 2 (index=1)
                "columnDefs": [
                    { "visible": false, "targets": 1 }  //Make the grouping column invisible.
                ],
                "order": [[ 1, 'asc' ], [2, 'asc'], [3, 'asc'], [4, 'asc'], [5, 'asc']],   //Set your sort order (first column is index 0)
                "displayLength": 25,

                //this selects which column to use for grouping, works best if this is the first column (position 0)
                rowGroup: {
                    dataSrc: [ 'building_location'],
                },
