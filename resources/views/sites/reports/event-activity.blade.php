...
@section ('title', trans('navs.frontend.reports.activity'))
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ trans('navs.frontend.reports.activity')}}</h3>
            </div>
            <div class="card-body">
                <form id="search-form">
                    <div class="row">
                ...
                <table id="reports-table" class="table table-condensed table-hover" width="100%">
                    ...
                    <tr>
                        ...
                        <th>{{ trans('labels.reports.building') }}</th>
                        <th>{{ trans('labels.reports.location') }}</th>
                        <th>{{ trans('labels.reports.course_abbreviation') }}</th>
                        <th>{{ trans('labels.reports.enrolled_user_count') }}</th>
                        <th>{{ trans('labels.reports.event_start') }}</th>
                        <th>{{ trans('labels.reports.event_end') }}</th>
                        <th>{{ trans('labels.reports.event_hours') }}</th>
                        <th>{{ trans('labels.reports.encounter_hours') }}</th>
                        <th>{{ trans('labels.reports.setup_time') }}</th>
                        <th>{{ trans('labels.reports.tear_down_time') }}</th>
                        <th>{{ trans('labels.reports.room_hours') }}</th>
                        <th>{{ trans('labels.reports.class_limit') }}</th>
                        <th>{{ trans('labels.reports.class_date') }}</th>
                        <th>{{ trans('labels.reports.notes') }}</th>
                        <th>{{ trans('labels.reports.internal_notes') }}</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
        ...
        $(function () {
            ...
            function loadDataTable(q = '') {
                return $('#reports-table').DataTable({
                    ...
                    responsive: true,
                    autoWidth: false,
                    ajax: `{{ route('reports-event-activities') }}?${q}`,
                    ...
                    columns: [
                        ...
                        {data: 'enrolled_user_count', name: 'enrolled_user_count'},
                        {data: 'start_time', name: 'start_time'},
                        {data: 'end_time', name: 'end_time'},
                        {data: 'event_hours', name: 'event_hours'},
                        {data: 'encounter_hours', name: 'encounter_hours'},
                        {data: 'setup_time', name: 'setup_time'},
                        {data: 'teardown_time', name: 'teardown_time'},
                        {data: 'room_hours', name: 'room_hours'},
                        {data: 'class_limit', name: 'class_limit'},
