...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h3>{{ trans('labels.scheduling.new_request') }}</h3>
        @isset($scheduleRequest->no_schedulers)
            <h2>{{$scheduleRequest->no_schedulers}}</h2>
        @endisset
        <p><a href="http://{{ Session::get('url_root') }}/scheduleRequest/pending">{{ trans('labels.scheduling.view_pending') }}</a></p>
        <table>
            <tr>
