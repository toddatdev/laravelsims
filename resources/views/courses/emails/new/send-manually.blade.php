...
@section('content')
    {!! Form::model($email, ['class' => 'form-horizontal','method' => 'POST', 'action' => ['Course\CourseEmailsController@sendNow']]) !!}
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="float-left">
                            {{ link_to('/courses/courseInstanceEmails?type=2', trans('buttons.general.cancel'), ['class' => 'btn btn-warning btn-sm']) }}
                        </div>
