            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ trans('menus.backend.course.view-active') }}</h3>
...
@section('after-scripts')
    <script>
        $(function() {
            ...
            // GET course= from url, if the course exists set the datatable to only it's id
            let course = "{{ app('request')->input('id') }}";

            $('#courses-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{!! url('coursesactive.data') !!}',
                    data: function (d) {
                        d.id = course;
                    }
                },
                ...
                order: [[ 0, "asc" ]] // DataTables defaults column to sort, this overwrites that
