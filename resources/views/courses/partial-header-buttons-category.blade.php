<div class="pull-right d-none d-lg-block">
    ...
    {{ link_to_route('create_course_category_group', trans('buttons.backend.courses.addGroup'), [$course->id], ['class' => 'btn btn-success btn-sm']) }}
...
<div class="pull-right d-lg-none">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li>{{ link_to_route('create_course_category_group', trans('buttons.backend.courses.addGroup'), [$course->id]) }}</li>
