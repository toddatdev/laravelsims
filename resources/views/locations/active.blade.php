            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ trans('menus.backend.location.view-active') }}</h3>
                            ...
                            <table id="locations_table" class="table dt-responsive nowrap table-hover indent_first_child">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-priority="0">{{ trans('labels.locations.order') }}</th>
                                        <th>{{ trans('labels.locations.building_abbrv') }}</th>
                                        <th data-priority="1">{{ trans('labels.locations.abbrv') }}</th>
                                        ...
                                        <th data-priority="2">{{ trans('labels.general.actions') }}</th> {{-- Added from the locationTableController--}}
                                    </tr>
                                </thead>
                            </table>
