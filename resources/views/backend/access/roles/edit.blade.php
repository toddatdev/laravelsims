            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <!-- header is decided by role type 1 = site, 2 = course, 3 = event -->
                        @if($type == '2')
                            <h3 class="card-title">{{ trans('labels.backend.access.roles.edit_course') }}</h3>
                        @elseif($type == '3')
                            <h3 class="card-title">{{ trans('labels.backend.access.roles.edit_event') }}</h3>
                        @else
                            <h3 class="card-title">{{ trans('labels.backend.access.roles.edit_site') }}</h3>
                        @endif
                    ...
                    <div class="card-footer">
                        <div class="float-left">
                            {{ link_to_route('admin.access.role.index', trans('buttons.general.cancel'), ['type'=>$type], ['class' => 'btn btn-warning btn-md']) }}
                        </div>
                        <div class="float-right">
