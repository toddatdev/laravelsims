...
@section ('title', trans('labels.scheduling.scheduling') . ' | ' . trans('labels.scheduling.duplicate_event'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">{{ trans('labels.scheduling.duplicate_event') }}</h3>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="float-right">
                            {{ Form::submit(trans('buttons.general.crud.create'), ['class' => 'btn btn-success btn-md create-event-submit', 'name'=>'submit', 'value'=>'save']) }}
                        </div><!--pull-right-->
                    </div><!-- /.card-footer -->
