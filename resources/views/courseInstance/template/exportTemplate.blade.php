...
@section ('title', trans('labels.template.template') . ' | ' . trans('labels.general.export'))

@section('page-header')
    <h4>
        {{ trans('labels.template.template') . ' - ' . trans('labels.general.export') }} <span class="text-success">{{ $templateName }}</span>
    </h4>
@endsection
