<div class="modal fade" id="resultReport{{$eventUserQse->id}}Modal" tabindex="-1"
     aria-labelledby="resultReport{{$eventUserQse->id}}ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resultReport{{$eventUserQse->id}}ModalLabel">{{$eventUserQse->qse->courseContents->menu_title}} {{ trans('labels.qse.quiz_results', ['for' => $eventUserQse->eventUser->user->name]) }}</h5>
