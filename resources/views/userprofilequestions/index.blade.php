...
@section('content')
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('menus.backend.user-profile-questions.view-all') }}</h3>
                ...
                <table id="questions-table" class="table table-condensed table-hover">
                    ...
                    <tr class="row1" data-id="{{ $question->question_id }}">
                      ...
                      <td>
                        ...
                        @if($question->retire_date == NULL)
                        <a href="{{route('retire_user_profile_question', ['id' => $question->question_id])}}" class="btn btn-sm btn-warning">
                          <i class="fa fa-lg fa-pause" data-toggle="tooltip" data-placement="top" title="Retire"></i>
                        </a>
                        @else
