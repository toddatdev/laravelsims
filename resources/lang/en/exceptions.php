...
return [
    ...
    */
    ...
    'general' => [
        'unexpected_error'  => 'An unexpected error has occured. :details.',
    ],
    ...
    'frontend' => [
        ...
        'addClass' => [
            'timelap_title' => 'Overlapping Times!',
            'timelap_text' => 'Event start and end times may not overlap',
            'overlap_title' => 'Resource Conflict!',
            'overlap_text' => 'What would you like to do?',
            'overlap_button1' => 'Return to edit',
            'overlap_button2' => 'Accept conflict',
            'missingFields_title' => 'Missing Fields!',
            'missingFields_text' => 'You must complete all required fields',
            'initialMeetingRoom_title' => 'Initial Meeting Room',
            'initialMeetingRoom_text' => 'You must select an initial meeting room',
        ],
        'enrollment' => [
            'no_fee_type' => 'Fee type must be selected to calculate amount. Please try again.',
            'no_amount' => 'The amount has not been calculated correctly. Please try again.',
        ],
    ],
];
