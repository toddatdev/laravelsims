...
class StoreCourseInstanceRequest2 extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'instructor_report' => 'required', 'numeric',
            'instructor_leave'  => 'required', 'numeric',
            'start_time'            => 'required',
            'end_time'            => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'instructor_report.required' => trans('validation.required', ['attribute' => trans('validation.attributes.schedule.fac_report')]),
            'instructor_leave.required' => trans('validation.required', ['attribute' => trans('validation.attributes.schedule.fac_leave')]),
