...
// I added this to get the site_id for the user_sites table -jl 2018-03-29 15:45 
use Session;
    ...
    public function getForDataTable($status = 1, $trashed = false)
    {
        ...
        $dataTableQuery = $this->query()
            ...
            ->select([
                ...
                config('access.users_table').'.middle_name',
    ...
    public function create($input)
    {
        ...
        DB::transaction(function () use ($user, $data, $roles) {
            if ($user->save()) {
                ...
                //adds the user_id, site_id combination to the user_sites table (if not already there) -jl 2018-03-29 11:21 
