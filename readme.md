...
In order to use the docker-compose up command, you will need to set the following env variables.
```
- AWS_KEY
- AWS_SECRET
```
Those are used by the app to authenticate to the S3 bucket. 