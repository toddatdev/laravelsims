...
h={};d.each(b,function(g,k){h[k]=f[k]});d.each(e,function(g,k){k.type="cell";if(c)g=d(c);else{g=a;for(var l=b,n=d(),p=0,q=l.length;p<q;p++)n=n.add(ma(g,l[p]));g=n.toArray()}k.attach=g;k.fields=f;k.displayFields=h});return e},fields:function(a){var b={};if(Array.isArray(a)){for(var c=0,e=a.length;c<e;c++){var f=Y.fields.call(this,a[c]);b[a[c]]=f[a[c]]}return b}var h={};c=this.s.fields;a||(a="keyless");d.each(c,function(g,k){g=k.dataSrc();g=ma(a,g);g=g.filter("[data-editor-value]").length?g.attr("data-editor-value"):
g.html();k.valToData(h,null===g?m:g)});b[a]={idSrc:a,data:h,node:t,fields:c,type:"row"};return b},create:function(a,b){if(b){var c=Y.id.call(this,b);try{la(c).length&&wa(c,a,b)}catch(e){}}},edit:function(a,b,c){a=Y.id.call(this,c)||"keyless";wa(a,b,c)},remove:function(a,b){la(a).remove()}},xc={wrapper:"DTE",processing:{indicator:"DTE_Processing_Indicator",active:"processing"},header:{wrapper:"DTE_Header",content:"DTE_Header_Content"},body:{wrapper:"DTE_Body",content:"DTE_Body_Content"},footer:{wrapper:"DTE_Footer",
...
multiValue:"multi-value",multiInfo:"multi-info",multiRestore:"multi-restore",multiNoEdit:"multi-noEdit",disabled:"disabled",processing:"DTE_Processing_Indicator"},actions:{create:"DTE_Action_Create",edit:"DTE_Action_Edit",remove:"DTE_Action_Remove"},inline:{wrapper:"DTE DTE_Inline",liner:"DTE_Inline_Field",buttons:"DTE_Inline_Buttons"},bubble:{wrapper:"DTE DTE_Bubble",liner:"DTE_Bubble_Liner",table:"DTE_Bubble_Table",close:"icon close",pointer:"DTE_Bubble_Triangle",bg:"DTE_Bubble_Background"}},ea=
...
[a._val])},enable:function(a){a._input.find("input").prop("disabled",!1);a._enabled=!0},disable:function(a){a._input.find("input").prop("disabled",!0);a._enabled=!1},canReturnSubmit:function(a,b){return!1}}),ca=d.extend(!0,{},J,{_addOptions:function(a,b,c){void 0===c&&(c=!1);a=a.dt;c&&a.clear();a.rows.add(b).draw()},create:function(a){var b=this;a.optionsPair=d.extend({label:"label",value:"value"},a.optionsPair);var c=d("<table>").addClass(ca.tableClass).width("100%").DataTable(d.extend({buttons:[],
columns:[{title:"Label",data:a.optionsPair.label}],deferRender:!0,dom:"fiBtp",language:{search:"",searchPlaceholder:"Search",paginate:{next:">",previous:"<"}},lengthChange:!1,select:{style:a.multiple?"os":"single"}},a.config));va.select.init(c);this.on("open",function(){c.search()&&c.search("").draw();c.columns.adjust()});a.editor&&(a.editor.table(c),a.editor.on("submitComplete",function(e,f,h,g){if("create"===g)for(e=function(k){c.rows(function(l,n){return n===f.data[k]}).select()},h=0;h<f.data.length;h++)e(h);
else"edit"!==g&&"remove"!==g||b._dataSource("refresh")}));a.dt=c;ca._addOptions(a,a.options||[]);a=d(c.table(m).container());return{input:a,side:d('<div class="DTE_Field_Type_datatable_info">').append(a.find("div.dataTables_filter")).append(a.find("div.dt-buttons")).append(a.find("div.dataTables_info"))}},get:function(a){var b=a.dt.rows({selected:!0}).data().pluck(a.optionsPair.value).toArray();return a.separator||!a.multiple?b.join(a.separator||","):b},set:function(a,b,c){a.multiple&&a.separator&&
!Array.isArray(b)?b="string"===typeof b?b.split(a.separator):[]:Array.isArray(b)||(b=[b]);var e=a.optionsPair.value;a.dt.rows({selected:!0}).deselect();a.dt.rows(function(f,h,g){return-1!==b.indexOf(h[e])}).select()},update:function(a,b,c){ca._addOptions(a,b,c);b=a._lastSet;b!==m&&ca.set(a,b,!0);S(d(a.dt.table().container()))},dt:function(a){return a.dt},tableClass:""}),Ec={className:"",compare:null,data:"",def:"",entityDecode:!0,fieldInfo:"",id:"",label:"",labelInfo:"",name:null,nullDefault:!1,type:"text",
message:"",multiEditable:!0,submit:!0,getFormatter:null,setFormatter:null},Fc=d.fn.dataTable,Gc=function(){function a(b,c,e){var f=this,h=e.internalI18n().multi,g=d.extend(!0,{},a.defaults,b);if(!y.fieldTypes[g.type])throw Error("Error adding field - unknown field type "+g.type);this.s={classes:c,host:e,multiIds:[],multiValue:!1,multiValues:{},name:g.name,opts:g,processing:!1,type:y.fieldTypes[g.type]};g.id||(g.id="DTE_Field_"+g.name);""===g.data&&(g.data=g.name);this.valFromData=function(l){return H._fnGetObjectDataFn(g.data)(l,
"editor")};this.valToData=H._fnSetObjectDataFn(g.data);var k=d('<div class="'+c.wrapper+" "+c.typePrefix+g.type+" "+c.namePrefix+g.name+" "+g.className+'"><label data-dte-e="label" class="'+c.label+'" for="'+y.safeId(g.id)+'">'+g.label+'<div data-dte-e="msg-label" class="'+c["msg-label"]+'">'+g.labelInfo+'</div></label><div data-dte-e="input" class="'+c.input+'"><div data-dte-e="input-control" class="'+c.inputControl+'"></div><div data-dte-e="multi-value" class="'+c.multiValue+'">'+h.title+'<span data-dte-e="multi-info" class="'+
c.multiInfo+'">'+h.info+'</span></div><div data-dte-e="msg-multi" class="'+c.multiRestore+'">'+h.restore+'</div><div data-dte-e="msg-error" class="'+c["msg-error"]+'"></div><div data-dte-e="msg-message" class="'+c["msg-message"]+'">'+g.message+'</div><div data-dte-e="msg-info" class="'+c["msg-info"]+'">'+g.fieldInfo+'</div></div><div data-dte-e="field-processing" class="'+c.processing+'"><span></span></div></div>');b=this._typeFn("create",g);e=null;b&&b.side&&(e=b.side,b=b.input);null!==b?A("input-control",
k).prepend(b):k.css("display","none");this.dom={container:k,inputControl:A("input-control",k),label:A("label",k).append(e),fieldInfo:A("msg-info",k),labelInfo:A("msg-label",k),fieldError:A("msg-error",k),fieldMessage:A("msg-message",k),multi:A("multi-value",k),multiReturn:A("msg-multi",k),multiInfo:A("multi-info",k),processing:A("field-processing",k)};this.dom.multi.on("click",function(){f.s.opts.multiEditable&&!k.hasClass(c.disabled)&&"readonly"!==g.type&&(f.val(""),f.focus())});this.dom.multiReturn.on("click",
function(){f.multiRestore()});d.each(this.s.type,function(l,n){"function"===typeof n&&f[l]===m&&(f[l]=function(){var p=Array.prototype.slice.call(arguments);p.unshift(l);p=f._typeFn.apply(f,p);return p===m?f:p})})}a.prototype.def=function(b){var c=this.s.opts;if(b===m)return b=c["default"]!==m?c["default"]:c.def,"function"===typeof b?b():b;c.def=b;return this};a.prototype.disable=function(){this.dom.container.addClass(this.s.classes.disabled);this._typeFn("disable");return this};a.prototype.displayed=
function(){var b=this.dom.container;return b.parents("body").length&&"none"!=b.css("display")?!0:!1};a.prototype.enable=function(b){void 0===b&&(b=!0);if(!1===b)return this.disable();this.dom.container.removeClass(this.s.classes.disabled);this._typeFn("enable");return this};a.prototype.enabled=function(){return!1===this.dom.container.hasClass(this.s.classes.disabled)};a.prototype.error=function(b,c){var e=this.s.classes;b?this.dom.container.addClass(e.error):this.dom.container.removeClass(e.error);
this._typeFn("errorMessage",b);return this._msg(this.dom.fieldError,b,c)};a.prototype.fieldInfo=function(b){return this._msg(this.dom.fieldInfo,b)};a.prototype.isMultiValue=function(){return this.s.multiValue&&1!==this.s.multiIds.length};a.prototype.inError=function(){return this.dom.container.hasClass(this.s.classes.error)};a.prototype.input=function(){return this.s.type.input?this._typeFn("input"):d("input, select, textarea",this.dom.container)};a.prototype.focus=function(){this.s.type.focus?this._typeFn("focus"):
d("input, select, textarea",this.dom.container).focus();return this};a.prototype.get=function(){return this.isMultiValue()?m:this._format(this._typeFn("get"),this.s.opts.getFormatter)};a.prototype.hide=function(b){var c=this.dom.container;b===m&&(b=!0);this.s.host.display()&&b&&d.fn.slideUp?c.slideUp():c.css("display","none");return this};a.prototype.label=function(b){var c=this.dom.label,e=this.dom.labelInfo.detach();if(b===m)return c.html();c.html(b);c.append(e);return this};a.prototype.labelInfo=
function(b){return this._msg(this.dom.labelInfo,b)};a.prototype.message=function(b,c){return this._msg(this.dom.fieldMessage,b,c)};a.prototype.multiGet=function(b){var c=this.s.multiValues,e=this.s.multiIds,f=this.isMultiValue();if(b===m){var h=this.val();b={};for(var g=0;g<e.length;g++)b[e[g]]=f?c[e[g]]:h}else b=f?c[b]:this.val();return b};a.prototype.multiRestore=function(){this.s.multiValue=!0;this._multiValueCheck()};a.prototype.multiSet=function(b,c){var e=this,f=this.s.multiValues,h=this.s.multiIds;
c===m&&(c=b,b=m);var g=function(k,l){-1===d.inArray(k,h)&&h.push(k);f[k]=e._format(l,e.s.opts.setFormatter)};d.isPlainObject(c)&&b===m?d.each(c,function(k,l){g(k,l)}):b===m?d.each(h,function(k,l){g(l,c)}):g(b,c);this.s.multiValue=!0;this._multiValueCheck();return this};a.prototype.name=function(){return this.s.opts.name};a.prototype.node=function(){return this.dom.container[0]};a.prototype.nullDefault=function(){return this.s.opts.nullDefault};a.prototype.processing=function(b){if(b===m)return this.s.processing;
this.dom.processing.css("display",b?"block":"none");this.s.processing=b;this.s.host.internalEvent("processing-field",[b]);return this};a.prototype.set=function(b,c){void 0===c&&(c=!0);var e=function(g){return"string"!==typeof g?g:g.replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#163;/g,"£").replace(/&#39;/g,"'").replace(/&#10;/g,"\n")};this.s.multiValue=!1;var f=this.s.opts.entityDecode;if(f===m||!0===f)if(Array.isArray(b)){f=0;for(var h=b.length;f<
h;f++)b[f]=e(b[f])}else b=e(b);!0===c?(b=this._format(b,this.s.opts.setFormatter),this._typeFn("set",b),this._multiValueCheck()):this._typeFn("set",b);return this};a.prototype.show=function(b,c){void 0===b&&(b=!0);void 0===c&&(c=!0);if(!1===c)return this.hide(b);c=this.dom.container;this.s.host.display()&&b&&d.fn.slideDown?c.slideDown():c.css("display","");return this};a.prototype.update=function(b,c){void 0===c&&(c=!1);this.s.type.update&&this._typeFn("update",b,c)};a.prototype.val=function(b){return b===
m?this.get():this.set(b)};a.prototype.compare=function(b,c){return(this.s.opts.compare||ka)(b,c)};a.prototype.dataSrc=function(){return this.s.opts.data};a.prototype.destroy=function(){this.dom.container.remove();this._typeFn("destroy");return this};a.prototype.multiEditable=function(){return this.s.opts.multiEditable};a.prototype.multiIds=function(){return this.s.multiIds};a.prototype.multiInfoShown=function(b){this.dom.multiInfo.css({display:b?"block":"none"})};a.prototype.multiReset=function(){this.s.multiIds=
[];this.s.multiValues={}};a.prototype.submittable=function(){return this.s.opts.submit};a.prototype._errorNode=function(){return this.dom.fieldError};a.prototype._format=function(b,c){if(c){if(Array.isArray(c)){c=c.slice();var e=c.shift();c=a.formatters[e].apply(this,c)}return c.call(this.s.host,b,this)}return b};a.prototype._msg=function(b,c,e){if(c===m)return b.html();if("function"===typeof c){var f=this.s.host;c=c(f,new Fc.Api(f.internalSettings().table))}b.parent().is(":visible")&&d.fn.animate?
(b.html(c),c?b.slideDown(e):b.slideUp(e)):(b.html(c||"").css("display",c?"block":"none"),e&&e());return this};a.prototype._multiValueCheck=function(){var b=this.s.multiIds,c=this.s.multiValues,e=this.s.multiValue,f=this.s.opts.multiEditable,h=!1;if(b)for(var g=0;g<b.length;g++){var k=c[b[g]];if(0<g&&!ka(k,l)){h=!0;break}var l=k}h&&e||!f&&this.isMultiValue()?(this.dom.inputControl.css({display:"none"}),this.dom.multi.css({display:"block"})):(this.dom.inputControl.css({display:"block"}),this.dom.multi.css({display:"none"}),
e&&!h&&this.set(l,!1));this.dom.multiReturn.css({display:b&&1<b.length&&h&&!e?"block":"none"});l=this.s.host.internalI18n().multi;this.dom.multiInfo.html(f?l.info:l.noMulti);this.dom.multi.toggleClass(this.s.classes.multiNoEdit,!f);this.s.host.internalMultiInfo();return!0};a.prototype._typeFn=function(b){for(var c=[],e=1;e<arguments.length;e++)c[e-1]=arguments[e];c.unshift(this.s.opts);if(e=this.s.type[b])return e.apply(this.s.host,c)};a.defaults=Ec;a.formatters={};return a}(),Hc={action:null,className:null,
tabIndex:0,text:null},Ic={close:function(){},init:function(){},open:function(){},node:function(){}},K=d.fn.dataTable.Api.register;K("editor()",function(){return R(this)});K("row.create()",function(a){var b=R(this);b.create(X(b,a,"create"));return this});K("row().edit()",function(a){var b=R(this);b.edit(this[0][0],X(b,a,"edit"));return this});K("rows().edit()",function(a){var b=R(this);b.edit(this[0],X(b,a,"edit"));return this});K("row().delete()",function(a){var b=R(this);b.remove(this[0][0],X(b,
a,"remove",1));return this});K("rows().delete()",function(a){var b=R(this);b.remove(this[0],X(b,a,"remove",this[0].length));return this});K("cell().edit()",function(a,b){a?d.isPlainObject(a)&&(b=a,a="inline"):a="inline";R(this)[a](this[0][0],b);return this});K("cells().edit()",function(a){R(this).bubble(this[0],a);return this});K("file()",Ea);K("files()",Fa);d(t).on("xhr.dt",function(a,b,c){"dt"===a.namespace&&c&&c.files&&d.each(c.files,function(e,f){y.files[e]||(y.files[e]={});d.extend(y.files[e],
f)})});var U=d.fn.dataTable.ext.buttons;d.extend(U,{create:{text:function(a,b,c){return a.i18n("buttons.create",c.editor.i18n.create.button)},className:"buttons-create",editor:null,formButtons:{text:function(a){return a.i18n.create.submit},action:function(a){this.submit()}},formMessage:null,formOptions:{},formTitle:null,action:function(a,b,c,e){var f=this;a=e.editor;this.processing(!0);a.one("preOpen",function(){f.processing(!1)}).create(d.extend({buttons:e.formButtons,message:e.formMessage||a.i18n.create.message,
title:e.formTitle||a.i18n.create.title,nest:!0},e.formOptions))}},createInline:{text:function(a,b,c){return a.i18n("buttons.create",c.editor.i18n.create.button)},className:"buttons-create",editor:null,formButtons:{text:function(a){return a.i18n.create.submit},action:function(a){this.submit()}},formOptions:{},action:function(a,b,c,e){e.editor.inlineCreate(e.position,e.formOptions)},position:"start"},edit:{extend:"selected",text:function(a,b,c){return a.i18n("buttons.edit",c.editor.i18n.edit.button)},
className:"buttons-edit",editor:null,formButtons:{text:function(a){return a.i18n.edit.submit},action:function(a){this.submit()}},formMessage:null,formOptions:{},formTitle:null,action:function(a,b,c,e){var f=this;a=e.editor;c=b.rows({selected:!0}).indexes();var h=b.columns({selected:!0}).indexes();b=b.cells({selected:!0}).indexes();b=h.length||b.length?{rows:c,columns:h,cells:b}:c;this.processing(!0);a.one("preOpen",function(){f.processing(!1)}).edit(b,d.extend({buttons:e.formButtons,message:e.formMessage||
a.i18n.edit.message,title:e.formTitle||a.i18n.edit.title,nest:!0},e.formOptions))}},remove:{extend:"selected",limitTo:["rows"],text:function(a,b,c){return a.i18n("buttons.remove",c.editor.i18n.remove.button)},className:"buttons-remove",editor:null,formButtons:{text:function(a){return a.i18n.remove.submit},action:function(a){this.submit()}},formMessage:function(a,b){b=b.rows({selected:!0}).indexes();a=a.i18n.remove;return("string"===typeof a.confirm?a.confirm:a.confirm[b.length]?a.confirm[b.length]:
a.confirm._).replace(/%d/g,b.length)},formOptions:{},formTitle:null,action:function(a,b,c,e){var f=this;a=e.editor;this.processing(!0);a.one("preOpen",function(){f.processing(!1)}).remove(b.rows({selected:!0}).indexes(),d.extend({buttons:e.formButtons,message:e.formMessage,title:e.formTitle||a.i18n.remove.title,nest:!0},e.formOptions))}}});U.editSingle=d.extend({},U.edit);U.editSingle.extend="selectedSingle";U.removeSingle=d.extend({},U.remove);U.removeSingle.extend="selectedSingle";var y=function(){function a(b){var c=
this;this.add=Na;this.ajax=Oa;this.background=Pa;this.blur=Qa;this.bubble=Ra;this.bubblePosition=Sa;this.buttons=Ta;this.clear=Ua;this.close=Va;this.create=Wa;this.undependent=Xa;this.dependent=Ya;this.destroy=Za;this.disable=$a;this.display=ab;this.displayed=bb;this.displayNode=cb;this.edit=db;this.enable=eb;this.error=fb;this.field=gb;this.fields=hb;this.file=Ea;this.files=Fa;this.get=ib;this.hide=jb;this.ids=kb;this.inError=lb;this.inline=mb;this.inlineCreate=nb;this.message=ob;this.mode=pb;this.modifier=
qb;this.multiGet=rb;this.multiSet=sb;this.node=tb;this.off=ub;this.on=vb;this.one=wb;this.open=xb;this.order=yb;this.remove=zb;this.set=Ab;this.show=Bb;this.submit=Cb;this.table=Db;this.template=Eb;this.title=Fb;this.val=Hb;this._actionClass=Lb;this._ajax=Mb;this._animate=Nb;this._assembleMain=Ob;this._blur=Pb;this._clearDynamicInfo=Qb;this._close=Rb;this._closeReg=Sb;this._crudArgs=Tb;this._dataSource=Ub;this._displayReorder=Vb;this._edit=Wb;this._event=Xb;this._eventName=Yb;this._fieldFromNode=
Zb;this._fieldNames=$b;this._focus=ac;this._formOptions=bc;this._inline=dc;this._optionsUpdate=ec;this._message=fc;this._multiInfo=hc;this._nestedClose=ic;this._nestedOpen=jc;this._postopen=kc;this._preopen=lc;this._processing=mc;this._noProcessing=nc;this._submit=oc;this._submitTable=pc;this._submitSuccess=qc;this._submitError=rc;this._tidy=sc;this._weakInArray=tc;this instanceof a||alert("DataTables Editor must be initialised as a 'new' instance");b=d.extend(!0,{},a.defaults,b);this.s=d.extend(!0,
{},a.models.settings,{actionName:b.actionName,table:b.domTable||b.table,ajax:b.ajax,idSrc:b.idSrc,formOptions:b.formOptions,template:b.template?d(b.template).detach():null});this.classes=d.extend(!0,{},a.classes);this.i18n=b.i18n;a.models.settings.unique++;var e=this,f=this.classes,h=d('<div class="'+f.wrapper+'"><div data-dte-e="processing" class="'+f.processing.indicator+'"><span></span></div><div data-dte-e="body" class="'+f.body.wrapper+'"><div data-dte-e="body_content" class="'+f.body.content+
'"></div></div><div data-dte-e="foot" class="'+f.footer.wrapper+'"><div class="'+f.footer.content+'"></div></div></div>'),g=d('<form data-dte-e="form" class="'+f.form.tag+'"><div data-dte-e="form_content" class="'+f.form.content+'"></div></form>');this.dom={wrapper:h[0],form:g[0],formError:d('<div data-dte-e="form_error" class="'+f.form.error+'"></div>')[0],formInfo:d('<div data-dte-e="form_info" class="'+f.form.info+'"></div>')[0],header:d('<div data-dte-e="head" class="'+f.header.wrapper+'"><div class="'+
f.header.content+'"></div></div>')[0],buttons:d('<div data-dte-e="form_buttons" class="'+f.form.buttons+'"></div>')[0],formContent:A("form_content",g)[0],footer:A("foot",h)[0],body:A("body",h)[0],bodyContent:A("body_content",h)[0],processing:A("processing",h)[0]};d.each(b.events,function(l,n){e.on(l,function(){var p=Array.prototype.slice.call(arguments);p.shift();n.apply(e,p)})});var k=this.s.table;b.fields&&this.add(b.fields);d(t).on("init.dt.dte"+this.s.unique,function(l,n,p){c.s.table&&n.nTable===
d(k)[0]&&(n._editor=c)}).on("i18n.dt.dte"+this.s.unique,function(l,n){c.s.table&&n.nTable===d(k)[0]&&n.oLanguage.editor&&d.extend(!0,c.i18n,n.oLanguage.editor)}).on("xhr.dt.dte"+this.s.unique,function(l,n,p){p&&c.s.table&&n.nTable===d(k)[0]&&c._optionsUpdate(p)});if(!a.display[b.display])throw Error("Cannot find display controller "+b.display);this.s.displayController=a.display[b.display].init(this);this._event("initComplete",[]);d(t).trigger("initEditor",[this])}a.prototype.internalEvent=function(b,
c){this._event(b,c)};a.prototype.internalI18n=function(){return this.i18n};a.prototype.internalMultiInfo=function(){return this._multiInfo()};a.prototype.internalSettings=function(){return this.s};a.fieldTypes={checkbox:aa,datatable:ca,datetime:Dc,hidden:yc,password:Bc,radio:ba,readonly:zc,select:Z,text:Ac,textarea:Cc,upload:qa,uploadMany:ja};a.files={};a.version="2.0.1";a.classes=xc;a.Field=Gc;a.DateTime=null;a.error=Ib;a.pairs=Jb;a.safeId=function(b){var c="";void 0===c&&(c="#");return"string"===
typeof b?c+b.replace(/\./g,"-"):c+b};a.upload=Kb;a.defaults=uc;a.models={button:Hc,displayController:Ic,fieldType:Ja,formOptions:T,settings:vc};a.dataSources={dataTable:V,html:Y};a.display={envelope:da,lightbox:W};return a}();I.Editor=y;d.fn.DataTable.Editor=y;I.DateTime&&(y.DateTime=I.DateTime);I.ext.editorFields&&d.extend(y.fieldTypes,I.ext.editorFields);I.ext.editorFields=y.fieldTypes;return y});
